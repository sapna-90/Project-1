...
if __name__ == "__main__": 
    ...
    button1 = Button(gui, text=' 9 ', fg='black', bg='Sky blue', 
                    command=lambda: press(9), height=3, width=8) 
    button1.grid(row=2, column=0) 
 
    button2 = Button(gui, text=' 8 ', fg='black', bg='Sky blue', 
                    command=lambda: press(8), height=3, width=8) 
    button2.grid(row=2, column=1) 
 
    button3 = Button(gui, text=' 7 ', fg='black', bg='Sky blue', 
                    command=lambda: press(7), height=3, width=8) 
    button3.grid(row=2, column=2) 
 
    button4 = Button(gui, text=' 6 ', fg='black', bg='Sky blue', 
    ...
    button6 = Button(gui, text=' 4 ', fg='black', bg='Sky blue', 
                    command=lambda: press(4), height=3, width=8) 
    button6.grid(row=3, column=2) 
 
    button7 = Button(gui, text=' 3 ', fg='black', bg='Sky blue', 
                    command=lambda: press(3), height=3, width=8) 
    button7.grid(row=4, column=0) 
 
    button8 = Button(gui, text=' 2 ', fg='black', bg='Sky blue', 
                    command=lambda: press(2), height=3, width=8) 
    button8.grid(row=4, column=1) 
 
    button9 = Button(gui, text=' 1 ', fg='black', bg='Sky blue', 
